...
namespace crypto
{
...

    {
        ...
        public static OneKey pubKeyOneKey = new OneKey();
        public static OneKey privKeyOneKey;
        ...
        public OneKey PubKey 
        { 
            get { return pubKeyOneKey; } 
        }

        public OneKey PrivKey
        {
            get { return privKeyOneKey; }
        }
        ...
        public OneKey(string parameters, AsymmetricKeyParameter publicKey = null, AsymmetricKeyParameter privateKey = null) : this()
        {
            if (publicKey != null)
            {
        ...
        private static OneKey GenerateEC2Key(CBORObject algorithm, string genParameters)
        {
            ...
            pubKeyOneKey = new OneKey(newmap);
        ...
        private Dictionary<string, CBORObject> algs = new Dictionary<string, CBORObject>() {
            {"1.2.840.10045.3.1.7", GeneralValues.P256 },{"1.3.132.0.34", GeneralValues.P384},{"1.3.132.0.35", GeneralValues.P521}
        };
        ...
        public void FromKey(AsymmetricKeyParameter x,string genParameters = null)
        {
            ...
            else if (x is ECPublicKeyParameters)
            {
                ...
                Console.WriteLine("gggg " + pub.Q.Normalize().XCoord.ToBigInteger().ToByteArrayUnsigned().Length.ToString());
                ...
                case "Ed25519":
                    {
                        ...
                        privKey.FromKey(cs.Private, genParameters);
                        newKey.FromKey(cs.Public, genParameters);
                        break;
                    }

...
namespace crypto
{
    public class Signer : Attributes
    {
        ...
        public static byte[] Sign(byte[] toBeSigned, CBORObject alg, Key keyToSign)
        {
            IDigest digest = null;
        ...
        public static bool Validate(byte[] content, CBORObject alg, Key signKey, byte[] rgbSignature)
        {
